...
Request a cloud account via Topdesk.
...
€23,- TB/month for object storage. Other services have their own pricing model.

## TRL

HIGH. See LINK for more information on Technology Readiness Levels (TRL).
