...
Most eloquent usage is for RWS in case of Jarkus data that is used in modelling. From 2010 until now periodic updates of data is made available via TDS of Deltares. 
...
TDS is hosted on a linux machine which needs regular updates. X Euro per year. Further, additional data storage costs are involved of €100,- TB/month. 
