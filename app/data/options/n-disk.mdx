...
As soon as a project number is requested for in proposal phase this project is automatically created. For a restricted N drive you need to make a topdesk call here.
